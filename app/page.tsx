    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-yellow-100 via-pink-100 to-blue-100">
      ...
      <footer className="py-6 w-full flex flex-col items-center border-t mt-auto bg-white/80">
        ...
        <div className="flex gap-4 mt-2">
          <a
            href="https://wa.me/?text=Check%20out%20DailyBuddy%20%E2%80%93%20your%20friendly%20companion%20for%20a%20brighter%2C%20more%20organized%20day!%20Try%20it%20now%3A%20https%3A%2F%2Fyour-app-link.com"
            target="_blank"
          ...
          <a
            href="https://web.whatsapp.com/send?text=Check%20out%20DailyBuddy%20%E2%80%93%20your%20friendly%20companion%20for%20a%20brighter%2C%20more%20organized%20day!%20Try%20it%20now%3A%20https%3A%2F%2Fyour-app-link.com"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <span className="text-xs text-gray-400 select-all">https://your-app-link.com</span>
        </div>
      </footer>
    </div>
  )
